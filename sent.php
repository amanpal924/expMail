        ...
        <div class="col-sm-3 col-md-2 sidebar">
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h3 class="page-header">Sent</h3>
            <table class="table table-striped overhead_limit">
                  <thead>
                    <tr>
                      <th width="5%">Id</th>
                      <th width="10%">To</th>
                    ...
                    <tbody>
                          ...
                          $d="SELECT * FROM message_details where sender_mail='{$_SESSION['id']}' and sender_delete=false and draft=false";
                          $result=mysqli_query($conn, $d); 
                          while ($temp = mysqli_fetch_assoc($result)) {
                              $d1="SELECT first_name,last_name FROM user_details where username='{$temp['reciever_mail']}'";
                              $result1 = mysqli_query($conn, $d1);
                              $q=mysqli_fetch_object($result1);
                              echo "<tr>";
                              echo "<td><a href='message.php?message_id=".$temp['msg_id']."&form=sent'>".$temp['msg_id']."</a></td>";
