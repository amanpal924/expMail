    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h3 class="page-header">Draft Messages</h3>
             <table class="table table-striped">
                  <thead>
                    ...
                    <tbody>
                          ...
                          $d="SELECT * FROM message_details where sender_mail='{$_SESSION['id']}' and draft=true";
                          $result=mysqli_query($conn, $d);
                          while($temp = mysqli_fetch_assoc($result)) {
                              if($temp['reciever_mail'] != ""){
                                  ...
                                  echo "<tr>";
                                  echo "<td><a href='message.php?message_id=".$temp['msg_id']."&form=draft'>".$temp['msg_id']."</a></td>";
